import 'dart:convert';
PropertyDetailResponseBody propertyDetailResponseBodyFromJson(String str) => PropertyDetailResponseBody.fromJson(json.decode(str));
String propertyDetailResponseBodyToJson(PropertyDetailResponseBody data) => json.encode(data.toJson());
class PropertyDetailResponseBody {
  PropertyDetailResponseBody({
      this.property,});

  PropertyDetailResponseBody.fromJson(dynamic json) {
